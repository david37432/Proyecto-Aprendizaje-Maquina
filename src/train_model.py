...
def run_training(output_dir: str = "../reports") -> None:
    """
    Entrena modelos de regresión y clasificación sobre datos preparados.

    Args:
        output_dir: Directorio donde se guardarán métricas y reportes.
    """
    ...
    with open(os.path.join(MODEL_DIR, "features.json"), "w") as f:
        json.dump(features_selected_regression, f, indent=4)
